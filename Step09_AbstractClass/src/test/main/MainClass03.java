...
public class MainClass03 {
	public static void main(String[] args) {
		// Zoo 객체를 생성해서 참조값 z1 이라는 변수에 담아보세요
		Zoo z1 = new Zoo();
		
		// z1에 있는 참조값을 이용해서 getMonkey() 메소드를 호출 후 리턴되는 값을 m1이라는 변수에 담아보세요
		...
		Zoo z2 = new Zoo();
		// z2에 있는 참조값을 이용해서 getMonkey() 메소드를 호출 후 리턴되는 값을 t1이라는 변수에 담아보세요
